...
export const FAQSection: React.FC = () => {
    const faqs = [
        ...
        },
        {
            ...
            answer: "In most cases, funds are disbursed within 1 business days after final approval of your application."
        },
        {
            question: "When will I receive my rewards?",
            answer: "Rewards will be distrubuted following the completion of the campaign. For more details, please refer to the terms and conditions on our website."
        },
        {
            ...
            answer: (
                <div className="space-y-2">
                    ...
                    <ul className="list-disc pl-5 space-y-1">
                        ...
                        <li>Latest 6 months consolidator's statement</li>
                        <li>Business proof - either GST number or Udyog Aadhar Certificate or Incorporation Certificate.</li>
                        <li>Company PAN card (not applicable for proprietor business)</li>
                        <li>Current Address Proof: Latest or previous month utility bill (electricity, gas or water bill) or rent agreement along with aadhar card</li>
            ...
            Frequently Asked <span className="text-mihuru-gold">Questions</span>
                ...
                <div className="mt-10 bg-white/5 border border-white/10 rounded-lg p-5 text-center">
                    ...
                    <p className="text-mihuru-gold">
                        Contact our support team at <a href="mailto:partners@mihuru.com" className="underline hover:text-mihuru-gold-light">partners@mihuru.com</a> or call <a href="tel:+917977191328" className="underline hover:text-mihuru-gold-light">+91 7977191328</a>
                    </p>
                </div>
            </div>
        </div>
