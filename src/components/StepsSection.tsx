    ...
    const steps = [
        {
            ...
            reward: "Receive Amazon vouchers worth ₹ 750"
        },
        {
            number: "02",
            title: "Loan Disbursement",
            description: "After approval, funds will be transferred directly to Choosen Consolidator account",
            reward: "Get Mihuru goodies worth ₹ 3,000"
        },
        {
            number: "03",
            title: "Second Loan Disbursement",
            description: "Return for second business loan during the contest period",
            reward: "Earn smartwatch or speakers worth ₹ 5,000"
        },
        {
            number: "04",
