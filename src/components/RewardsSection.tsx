...
export const RewardsSection: React.FC = () => {
    ...
    const rewards = [
        ...
        {
            title: "Second Loan Disbursement",
            reward: "Smartwatch or Speakers",
            value: "Rs. 5,000",
            icon: <Watch className="h-6 w-6" />,
            description: "Earn premium rewards when you return for second business loan"
        }
    ];
        ...
        <div className="py-16 px-4">
            <div className="container mx-auto">
                <div className="text-center mb-12">
                    <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif font-bold mb-7 text-transparent bg-clip-text bg-gradient-to-r from-mihuru-gold to-mihuru-gold-light glowing-text">
                        Unlock Amazing Rewards and Business Opportunities
                    </h2>
